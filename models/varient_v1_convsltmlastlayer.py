...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        self.convsltm=ConvLSTM(512, 512, (3,3), 1, batch_first=True, bias=True, return_all_layers=False).cuda()
    ...
    def forward(self, x):
        ...
        output=self.convsltm(output)
        output=output[0]
        x=output.permute(0,2,1,3,4)
...
def r2plus1d_18_v1(pretrained=False, progress=True, **kwargs):
...
# model=r2plus1d_18(pretrained=False,progress=False).cuda()
