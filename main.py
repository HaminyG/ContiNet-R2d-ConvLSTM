...
if __name__ == '__main__':
    ...
    from models.Conv3D import resnet18,r2plus1d_18,resnet50
    from models.resnet2dlstm import ResCRNN
    # from models.ResNext import resnet50
    from models.C3d import C3D
    from models.varient_v1_convsltmlastlayer import r2plus1d_18_v1
    from models.varient_v2_nofusion import r2plus1d_18_v2
    from models.varient_v3_baseresnet import r2plus1d_18_v3
    from models.Xception import Xception
    from models.v4_r2plus1dwithfusion import r2plus1d_18_v4
    from models.PreActivation import generate_model
    from models.new_model_preActivation import r2plus1d_18_new_pre
    #from r2plus1d import r2plus1d_18
    best_acc1 = 0
    global model
    # Arguments
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', default='/home/han006/experiment_v3/CSL5000_100class/dataset/CSL5000_100classes/rawvideo',#/home/han006/experiment_v3/CSL5000_100class/dataset/CSL25000_500classes/xf500_color_video',
        type=str, help='Data path for training')
    parser.add_argument('--json_path', default='/home/han006/experiment_v3/CSL5000_100class/dataset/CSL5000_100classes/jsondata',
        type=str, help='json path for training')
    parser.add_argument('--model', default='r2plus1d_18_new_pre',required=False,
    ...
    if args.model == 'r2plus1d_18':
        model = r2plus1d_18(pretrained=False, num_classes=100)
    if args.model =='r2plus1d_18_new_pre':
        model = r2plus1d_18_new_pre(pretrained=False, progress=False,num_classes=100)
    elif args.model == 'r2plus1d_18_new':
        model = r2plus1d_18_new(pretrained=False, progress=False,num_classes=100)
    elif args.model == 'r2plus1d_18_v1':
        model = r2plus1d_18_v1(pretrained=False, progress=False,num_classes=100)
    elif args.model == 'r2plus1d_18_v2':
        model = r2plus1d_18_v2(pretrained=False, progress=False,num_classes=100)
    elif args.model == 'r2plus1d_18_v3':
        model = r2plus1d_18_v3(pretrained=False, progress=False,num_classes=100)
    elif args.model == 'r2plus1d_18_v4':
        model = r2plus1d_18_v4(pretrained=False, progress=False,num_classes=100)
    elif args.model == 'preactivation':
        model = generate_model(model_depth=18,n_classes=100,n_input_channels=3,shortcut_type='B',conv1_t_size=7,conv1_t_stride=1)
    elif args.model == '3dresnet18':
        model = resnet18(pretrained=False, sample_size=sample_size,
            sample_duration=16, num_classes=100)
    elif args.model == '3dresnet50':
        model = resnet50(pretrained=False, sample_size=sample_size,
            sample_duration=16, num_classes=100)
    elif args.model == 'Xception':
        model = Xception(num_classes=100)
    elif args.model == 'ResCRNN':
        model=ResCRNN(sample_size=112, sample_duration=16, num_classes=100, arch="resnet18")
    elif args.model == 'Resnext50':
        model = resnet50(spatial_size=112, sample_duration=16, num_classes=100).cuda()
    elif args.model == 'C3d':
        model = C3D(num_classes=100, pretrained=False)
